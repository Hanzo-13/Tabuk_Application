...
class TripRepository {
  ...
  Future<List<Map<String, dynamic>>> getTripsOnce(String userId) async {
    try {
      ...
      if (kDebugMode) debugPrint('Error loading cached trips: $e');
    }
    ...
    try {
      ...
      if (kDebugMode) debugPrint('Error fetching trips from Firestore: $e');
  ...
  Future<Map<String, dynamic>?> getTripOnce(
    ...
    try {
      ...
      if (kDebugMode) debugPrint('Error loading cached trip: $e');
    }
    ...
    try {
      ...
      if (kDebugMode) debugPrint('Error fetching trip from Firestore: $e');
      return null;
    }
  }
