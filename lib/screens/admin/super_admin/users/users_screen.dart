...
class _SuperUsersScreenState extends State<SuperUsersScreen>
  ...
  Stream<QuerySnapshot> _superAdminsStream() {
    return FirebaseFirestore.instance
        .collection('Users')
        .where('role', isEqualTo: 'Administrator')
        .where('admin_type', isEqualTo: 'Super Administrator')
        .snapshots();
  }
    ...
    return Scaffold(
          ...
          child: Container(
            ...
            child: TabBar(
              ...
              tabs: const [
                ...
                Tab(
                  icon: Icon(Icons.admin_panel_settings, size: 15),
                  text: "Super Admin",
                ),
              ],
            ),
      ...
      body: TabBarView(
        ...
        children: [
          ...
          _buildUserList(_superAdminsStream()),
        ],
      ),
    );
  }
