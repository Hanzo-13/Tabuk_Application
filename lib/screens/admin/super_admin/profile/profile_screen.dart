import 'package:capstone_app/screens/admin/provincial_admin/events/event_screen.dart';
...
class SuperProfileScreen extends StatefulWidget {
  const SuperProfileScreen({super.key});

  @override
  State<SuperProfileScreen> createState() => _SuperProfileScreenState();
}

class _SuperProfileScreenState extends State<SuperProfileScreen> with SingleTickerProviderStateMixin {
  final FirebaseAuth _auth = FirebaseAuth.instance;
  final FirebaseFirestore _firestore = FirebaseFirestore.instance;

  String name = '';
  String email = '';
  String role = 'Super Administrator';
  String province = '';
  String joinDate = '';
  bool isLoading = true;
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            _buildActionTile(
                              ...
                              onTap: () {
                                Navigator.of(context).push(
                                  MaterialPageRoute(builder: (context) => const SpotsScreen()),
                              );
                              },
                            ),
                            _buildActionTile(
                            ...
                            _buildActionTile(
                              ...
                              onTap: () {
                                Navigator.of(context).push(
                                  MaterialPageRoute(builder: (context) => const EventCalendarProvScreen()),
                              );
                              },
                            ),
                            _buildActionTile(
