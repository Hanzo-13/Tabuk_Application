...
class _ProvMapScreenState extends State<ProvMapScreen> {
  ...
  void _showAddDestinationForm(LatLng position) {
    final newHotspot = Hotspot(
      ...
      category: '', municipality: '', description: '', imageUrl: '', type: '', location: '', district: '', images: [], transportation: [], operatingHours: {}, contactInfo: '', restroom: false, foodAccess: false, createdAt: DateTime.now(),
    );
