...
class _EventCalendarAdminScreenState extends State<EventCalendarProvScreen>
  ...
  String? _adminType ='Provincial Administrator'; // Will be set based on user session
...
Widget _buildPastEventsList() {
  ...
  final _pastEvents =
      _events.where((e) => e.createdBy == currentUserId).toList();
