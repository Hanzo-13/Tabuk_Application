...
class MuniSpotRegistrationScreen extends StatefulWidget {
  final String adminRole; // "Municipal Administrator" or "Provincial Administrator"
  final String municipality; // For Municipal Admins, required

  const MuniSpotRegistrationScreen({
    super.key,
  ...
  @override
  State<MuniSpotRegistrationScreen> createState() => _MuniSpotRegistrationScreenState();
}

class _MuniSpotRegistrationScreenState extends State<MuniSpotRegistrationScreen> {
