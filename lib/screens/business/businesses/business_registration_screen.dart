// lib/screens/business_registration_form.dart
...
import 'package:capstone_app/screens/business/businesses/business_media_location_form_screen.dart';
...
Future<void> _pickTime(String day, String type) async {
  ...
  Future<void> _handleNextStep() async {
    ...
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (_) => BusinessMediaAndLocationScreen(documentId: docRef.id),
      ),
    );
  } catch (e) {
    if (mounted) {
        ...
        child: Form(
          ...
          child: Column(
            children: [
              ...
              const SizedBox(height: 12),
              TextFormField(controller: _suggestedItemsController, decoration: const InputDecoration(labelText: 'Suggested Items (comma-separated)')),
