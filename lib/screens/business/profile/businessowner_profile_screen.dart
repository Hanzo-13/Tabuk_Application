import 'package:capstone_app/screens/business/profile/edit_business_profile.dart';
...
class _BusinessProfileScreenState extends State<BusinessProfileScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text("Business Owner Profile", style: TextStyle(color: Colors.black)),
          ...
          : SingleChildScrollView(
              child: Column(
                children: [
                  ...
                  // Second card: Business actions
                  Card(
                    margin: const EdgeInsets.symmetric(horizontal: 16, vertical: 8),
                    child: Column(
                      children: [
                        buildActionTile(Icons.store_mall_directory, "Manage Businesses Information"),
                        buildActionTile(Icons.inventory_2, "Manage Promotions"),
                        buildActionTile(Icons.archive, "Archived Businesses"),
                      ],
                    ),
                  ),
