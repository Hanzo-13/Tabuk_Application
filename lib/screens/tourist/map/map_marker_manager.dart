  ...
  class MapMarkerManager {
    ...
    /// This is used for compass-based navigation mode.
    static Future<BitmapDescriptor> createLocationHeadingBitmap() async {
      ...
      // Outer circle (accuracy-like background)
      final Paint outerCirclePaint = Paint()
        ..color = const Color(0x334285F4)
        ..style = PaintingStyle.fill;
      canvas.drawCircle(const Offset(radius, radius), radius * 0.9, outerCirclePaint);
      ...
      // Heading arrow pointing up (north)
      final Path arrowPath = Path();
      arrowPath.moveTo(radius, radius * 0.2); // Top
      arrowPath.lineTo(radius - radius * 0.25, radius * 0.5); // Left
      arrowPath.lineTo(radius - radius * 0.1, radius * 0.5);
      arrowPath.lineTo(radius - radius * 0.1, radius * 0.85);
      arrowPath.lineTo(radius + radius * 0.1, radius * 0.85);
      arrowPath.lineTo(radius + radius * 0.1, radius * 0.5);
      arrowPath.lineTo(radius + radius * 0.25, radius * 0.5); // Right
      arrowPath.close();
