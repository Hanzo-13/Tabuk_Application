  ...
  Future<void> startLocationTracking() async {
    ...
    if (Platform.isIOS) {
      ...
      locationSettings = const LocationSettings(
        ...
        distanceFilter: 5,
        timeLimit: Duration(seconds: 15), // iOS may need more time for first location
      );
    } else {
    ...
    try {
      _positionStream = Geolocator.getPositionStream(
        ...
        onError: (error) {
          ...
          // User can restart manually or app will retry on resume
        },
      ...
      try {
        ...
        _positionStream = Geolocator.getPositionStream(
          ...
          _handleIncomingPosition,
          onError: (error) => print('Fallback location stream error: $error'),
        );
      } catch (e2) {
        print('Fallback location tracking also failed: $e2');
      }
    }
  }
  ...
  Future<void> requestLocationUpdate() async {
    try {
      ...
      try {
        ...
        print('Fallback position request also failed: $e2');
      }
    }
  }
